...
a_ouros = pygame.image.load('assets/img/cartas/').convert()
a_espadas = pygame.image.load('assets/img/cartas/').convert() 
a_paus = pygame.image.load('assets/img/cartas/').convert()
a_copas = pygame.image.load('assets/img/cartas/').convert()
dois_ouros = pygame.image.load('assets/img/cartas/').convert()
dois_espadas = pygame.image.load('assets/img/cartas/').convert()
dois_paus = pygame.image.load('assets/img/cartas/').convert()
dois_copas = pygame.image.load('assets/img/cartas/').convert()
tres_ouros = pygame.image.load('assets/img/cartas/').convert()
tres_espadas = pygame.image.load('assets/img/cartas/').convert()
tres_paus = pygame.image.load('assets/img/cartas/').convert()
tres_copas = pygame.image.load('assets/img/cartas/').convert()
quatro_ouros = pygame.image.load('assets/img/cartas/').convert()
quatro_espadas = pygame.image.load('assets/img/cartas/').convert()
quatro_paus = pygame.image.load('assets/img/cartas/').convert()
quatro_copas = pygame.image.load('assets/img/cartas/').convert()
cinco_ouros = pygame.image.load('assets/img/cartas/').convert()
cinco_espadas = pygame.image.load('assets/img/cartas/').convert()
cinco_paus = pygame.image.load('assets/img/cartas/').convert()
cinco_copas = pygame.image.load('assets/img/cartas/').convert()
seis_ouros = pygame.image.load('assets/img/cartas/').convert()
seis_espadas = pygame.image.load('assets/img/cartas/').convert()
seis_paus = pygame.image.load('assets/img/cartas/').convert()
seis_copas = pygame.image.load('assets/img/cartas/').convert()
sete_ouros = pygame.image.load('assets/img/cartas/').convert()
sete_espadas = pygame.image.load('assets/img/cartas/').convert()
sete_paus = pygame.image.load('assets/img/cartas/').convert()
sete_copas = pygame.image.load('assets/img/cartas/').convert()
